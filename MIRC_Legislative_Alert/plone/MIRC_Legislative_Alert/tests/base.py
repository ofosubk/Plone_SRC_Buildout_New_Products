...
def setup_product():
    ...
    import plone.MIRC_Legislative_Alert
    zcml.load_config('configure.zcml', plone.MIRC_Legislative_Alert)
    ...
    ztc.installPackage('plone.MIRC_Legislative_Alert')
...
setup_product()
ptc.setupPloneSite(products=['plone.MIRC_Legislative_Alert'])
