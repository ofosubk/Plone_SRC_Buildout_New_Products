...
def setup_product():
    ...
    import plone.MFPP_Library_Resource
    zcml.load_config('configure.zcml', plone.MFPP_Library_Resource)
    ...
    ztc.installPackage('plone.MFPP_Library_Resource')
...
setup_product()
ptc.setupPloneSite(products=['plone.MFPP_Library_Resource'])
