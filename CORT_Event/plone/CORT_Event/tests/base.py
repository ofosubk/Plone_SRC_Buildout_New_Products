...
def setup_product():
    ...
    import plone.CORT_Event
    zcml.load_config('configure.zcml', plone.CORT_Event)
    ...
    ztc.installPackage('plone.CORT_Event')
...
setup_product()
ptc.setupPloneSite(products=['plone.CORT_Event'])
