...
def setup_product():
    ...
    import plone.MIRC_Legislative_Alerts
    zcml.load_config('configure.zcml', plone.MIRC_Legislative_Alerts)
    ...
    ztc.installPackage('plone.MIRC_Legislative_Alerts')
...
setup_product()
ptc.setupPloneSite(products=['plone.MIRC_Legislative_Alerts'])
