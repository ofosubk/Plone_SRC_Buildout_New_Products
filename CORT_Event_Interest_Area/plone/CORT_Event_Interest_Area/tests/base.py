...
def setup_product():
    ...
    import plone.CORT_Event_Interest_Area
    zcml.load_config('configure.zcml', plone.CORT_Event_Interest_Area)
    ...
    ztc.installPackage('plone.CORT_Event_Interest_Area')
...
setup_product()
ptc.setupPloneSite(products=['plone.CORT_Event_Interest_Area'])
