...
def setup_product():
    ...
    import plone.CORT_Event_Category
    zcml.load_config('configure.zcml', plone.CORT_Event_Category)
    ...
    ztc.installPackage('plone.CORT_Event_Category')
...
setup_product()
ptc.setupPloneSite(products=['plone.CORT_Event_Category'])
