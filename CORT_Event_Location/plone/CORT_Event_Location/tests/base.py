...
def setup_product():
    ...
    import plone.CORT_Event_Location
    zcml.load_config('configure.zcml', plone.CORT_Event_Location)
    ...
    ztc.installPackage('plone.CORT_Event_Location')
...
setup_product()
ptc.setupPloneSite(products=['plone.CORT_Event_Location'])
